...
async def handle_call_tool(name: str, arguments: dict) -> list[TextContent]:
    ...
    handlers = {
        "lookup_model": _tool_lookup_model,
        "search_tech": _tool_search_tech,
        "get_torque_specs": _tool_get_torque_specs,
        "get_fluid_specs": _tool_get_fluid_specs,
        "get_maintenance_schedule": _tool_get_maintenance_schedule,
        "get_common_issues": _tool_get_common_issues,
        "decode_vin": _tool_decode_vin,
        "lookup_paint_code": _tool_lookup_paint_code,
        "lookup_option_code": _tool_lookup_option_code,
        "get_recalls": _tool_get_recalls,
        "get_tsbs": _tool_get_tsbs,
        "get_fault_codes": _tool_get_fault_codes,
        "get_brake_specs": _tool_get_brake_specs,
        "get_suspension_specs": _tool_get_suspension_specs,
        "get_tire_specs": _tool_get_tire_specs,
        "get_fuse_layout": _tool_get_fuse_layout,
        "get_gear_ratios": _tool_get_gear_ratios,
        "get_performance_data": _tool_get_performance_data,
        "get_market_value": _tool_get_market_value,
        "get_production_numbers": _tool_get_production_numbers,
        "get_engine_specs": _tool_get_engine_specs,
        "get_diy_guide": _tool_get_diy_guide,
